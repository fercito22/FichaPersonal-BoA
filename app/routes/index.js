...
export default Route.extend({
    beforeModel() {        
      ...
      servicioContacto: inject("contacto-emergencia-servicio"),
      servicioMedico: inject("medico-cabecera-servicio"),
      servicioBachiller: inject("bachiller-servicio"),
      servicioFormacionAcademica: inject("formacion-academica-servicio"),
      //servicioExpLaboral: inject("experiencia-laboral-servicio"),
    //   servicioVacaciones: inject("vacaciones-servicio"),
    //   servicioBeneficiarios: inject("beneficiarios-servicio"),
    //   servicioEntrenamiento: inject("entrenamiento-servicio"),
    //   servicioMemorandum: inject("memorandum-servicio"),
    //   servicioDeclaracion: inject("declaracion-servicio"),
      servicioFotografia: inject("fotografia-servicio"),       
